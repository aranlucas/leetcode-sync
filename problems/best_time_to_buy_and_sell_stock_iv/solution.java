class Solution {
    ...
    public int solve(int i, int transactionsRemaining, int holding, int[] prices, Integer[][][] memo) {
        ...
        if (holding == 1) {
            ...
            // If you're not holding, you can but stock. This decreases profit as you need to re-invest.
