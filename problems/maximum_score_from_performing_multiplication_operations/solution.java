class Solution {
    ...
    public int solve(int start, int multIndex, int[] multipliers, int[] nums, Integer[][] memo) {
        ...
        int begStart =
                solve(start + 1, multIndex + 1, multipliers, nums, memo)
                        + nums[start] * multipliers[multIndex];
        int endStart =
                solve(start, multIndex + 1, multipliers, nums, memo)
                        + nums[end] * multipliers[multIndex];
