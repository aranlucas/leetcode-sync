class Solution {
    ...
    public long solve(int i, int lane, int[] regular, int[] express, int expressCost, Long[][] memo){
        ...
        long expressLane = (lane == 1 ? expressCost : 0) + express[i] + solve(i - 1, 0, regular, express, expressCost, memo);
